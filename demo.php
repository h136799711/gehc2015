		...
		<div class="choose">
			...
			<div class="thumbnail clearfix">	
				<div class="swiper-container">
					...
					<div class="swiper-slide thumbnail-item <?php if($key == 0) echo "active" ?> ">		
					<img class="img-responsive" data-path="<?php echo $item['path']; ?>" data-id="<?php echo $item['id']; ?>" src="<?php echo $textpath.$item['path']; ?>"/>
					</div>
